        ...
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <li class="menu-item <?= $c_name == 'Applications' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-pen-fancy"></i> Applications'), 
                    ['controller' => 'Applications', 'action' => 'index', 'prefix' => false, ], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>

                <li class="menu-item <?= $c_name == 'Qualifications' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-user-graduate"></i> Qualifications'), 
                    ['controller' => 'qualifications', 'action' => 'index', 'prefix' => false, ], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>

                <li class="menu-item <?= $c_name == 'Skills' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-hammer"></i> Skills'), 
                    ['controller' => 'skills', 'action' => 'index', 'prefix' => false, ], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>

                <li class="menu-item <?= $c_name == 'Projects' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-sheet-plastic"></i> Projects'), 
                    ['controller' => 'projects', 'action' => 'index', 'prefix' => false, ], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>

                <li class="menu-item <?= $c_name == 'Languages' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-language"></i> Languages'), 
                    ['controller' => 'languages', 'action' => 'index', 'prefix' => false, ], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>

                <li class="menu-item <?= $c_name == 'Refers' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-handshake"></i> Refers'), 
                    ['controller' => 'refers', 'action' => 'index', 'prefix' => false, ], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
