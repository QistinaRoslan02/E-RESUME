...
class ApplicationsController extends AppController
{
	...
	public function pdfList()
	{
        ...
        $this->paginate = [
            'contain' => ['Skills', 'Languages', 'Qualifications', 'Projects', 'Refers'],
			'maxLimit' => 10,
        ];
    ...
    public function view($id = null)
    {
        ...
        $application = $this->Applications->get($id, contain: ['Skills', 'Languages', 'Qualifications', 'Projects', 'Refers']);
    ...
    public function pdf($id = null)
{
    ...
    public function add()
    {
        ...
        $skills = $this->Applications->Skills->find('list', ['limit' => 200])->all();
        $languages = $this->Applications->Languages->find('list', ['limit' => 200])->all();
        $qualifications = $this->Applications->Qualifications->find('list', ['limit' => 200])->all();
        $projects = $this->Applications->Projects->find('list', ['limit' => 200])->all();
        $refers = $this->Applications->Refers->find('list', ['limit' => 200])->all();
        $this->set(compact('application', 'skills', 'languages', 'qualifications', 'projects', 'refers'));
    }
